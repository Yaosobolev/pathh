...
export async function recreatePath(
  destinationCell: any,
  ...
  newBoard[destinationCell["row"]][destinationCell["col"]] = {
    ...newBoard[destinationCell["row"]][destinationCell["col"]],
    classes: [
      ...newBoard[destinationCell["row"]][destinationCell["col"]].classes,
      "found-destination",
      "path",
    ],
  };
  ...
  await new Promise((resolve) =>
    setTimeout(resolve, props.foundDestinationDelay)
  );

  let currentCell: any = {
    row: destinationCell["row"],
    col: destinationCell["col"],
    distance: destinationCell["distance"],
    parent: destinationCell["parent"],
  };
  const path: Cell[] = [];

  while (currentCell) {
    if (
      props.board[currentCell["row"]][currentCell["col"]].classes.includes(
        "visited"
      )
    ) {
      const newBoard = [...props.board];
      ...
      newBoard[currentCell["row"]][currentCell["col"]] = {
        ...newBoard[currentCell["row"]][currentCell["col"]],
        classes: [
          ...newBoard[currentCell["row"]][currentCell["col"]].classes,
          "path",
        ],
      };
